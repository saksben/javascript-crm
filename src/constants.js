/*
  ...
  Why do this? Because here they are a single source of truth - if they change here, they will change everywhere else, too.
 */
...
export const COMPANY_NAME_FIELD_NAME = "name"; //was "company_name", now is "name" to match api endpoint from ../db.json
